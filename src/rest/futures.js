...
function getFuturesBalanceSummary() {
    return this.request({
        ...
        endpoint: "".concat(constants_1.API_PREFIX, "/cfm/balance_summary"),
        isPublic: false,
    });
}
...
function getIntradayMarginSetting() {
    return this.request({
        method: request_types_1.method.GET,
        endpoint: "".concat(constants_1.API_PREFIX, "/cfm/intraday/margin_setting"),
        isPublic: false,
    });
}
...
function getCurrentMarginWindow(requestParams) {
    return this.request({
        method: request_types_1.method.GET,
        endpoint: "".concat(constants_1.API_PREFIX, "/cfm/intraday/current_margin_window"),
...
function listFuturesPositions() {
    return this.request({
        method: request_types_1.method.GET,
        endpoint: "".concat(constants_1.API_PREFIX, "/cfm/positions"),
        isPublic: false,
    });
}
...
function getFuturesPosition(_a) {
    var productId = _a.productId;
    return this.request({
        method: request_types_1.method.GET,
        endpoint: "".concat(constants_1.API_PREFIX, "/cfm/positions/").concat(productId),
        isPublic: false,
    });
}
...
function scheduleFuturesSweep(requestParams) {
    return this.request({
        method: request_types_1.method.POST,
        endpoint: "".concat(constants_1.API_PREFIX, "/cfm/sweeps/schedule"),
        bodyParams: requestParams,
        isPublic: false,
    });
}
...
function listFuturesSweeps() {
    return this.request({
        method: request_types_1.method.GET,
        endpoint: "".concat(constants_1.API_PREFIX, "/cfm/sweeps"),
        isPublic: false,
    });
}
