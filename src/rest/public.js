...
function getServerTime() {
    return this.request({
        ...
        endpoint: "".concat(constants_1.API_PREFIX, "/time"),
        isPublic: true,
    });
}
...
function getPublicProductBook(requestParams) {
    return this.request({
        method: request_types_1.method.GET,
        endpoint: "".concat(constants_1.API_PREFIX, "/market/product_book"),
...
function listPublicProducts(requestParams) {
    return this.request({
        method: request_types_1.method.GET,
        endpoint: "".concat(constants_1.API_PREFIX, "/market/products"),
        queryParams: requestParams,
        isPublic: true,
    });
}
...
function getPublicProduct(_a) {
    var productId = _a.productId;
    return this.request({
        method: request_types_1.method.GET,
        endpoint: "".concat(constants_1.API_PREFIX, "/market/products/").concat(productId),
        isPublic: true,
    });
}
...
function getPublicProductCandles(_a) {
    var productId = _a.productId, requestParams = __rest(_a, ["productId"]);
    return this.request({
        method: request_types_1.method.GET,
        endpoint: "".concat(constants_1.API_PREFIX, "/market/products/").concat(productId, "/candles"),
        queryParams: requestParams,
        isPublic: true,
    });
}
...
function getPublicMarketTrades(_a) {
    ...
    return this.request({
        method: request_types_1.method.GET,
        endpoint: "".concat(constants_1.API_PREFIX, "/products/").concat(productId, "/ticker"),
        queryParams: requestParams,
        isPublic: true,
    });
}
