...
function getBestBidAsk(requestParams) {
    return this.request({
        ...
        endpoint: "".concat(constants_1.API_PREFIX, "/best_bid_ask"),
...
function getProductBook(requestParams) {
    return this.request({
        method: request_types_1.method.GET,
        endpoint: "".concat(constants_1.API_PREFIX, "/product_book"),
        queryParams: requestParams,
        isPublic: false,
    });
}
...
function listProducts(requestParams) {
    return this.request({
        method: request_types_1.method.GET,
        endpoint: "".concat(constants_1.API_PREFIX, "/products"),
        queryParams: requestParams,
        isPublic: false,
    });
}
...
function getProduct(_a) {
    ...
    return this.request({
        method: request_types_1.method.GET,
        endpoint: "".concat(constants_1.API_PREFIX, "/products/").concat(productId),
        queryParams: requestParams,
        isPublic: false,
    });
}
...
function getProductCandles(_a) {
    ...
    return this.request({
        method: request_types_1.method.GET,
        endpoint: "".concat(constants_1.API_PREFIX, "/products/").concat(productId, "/candles"),
        queryParams: requestParams,
        isPublic: false,
    });
}
